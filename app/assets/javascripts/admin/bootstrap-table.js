...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatLoadingMessage: function () {
            return 'Carregando, espere...';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            // return sprintf('Mostrando %s à %s de %s registros', pageFrom, pageTo, totalRows);
            return sprintf('Total de %s registros, ', totalRows);
        },
